...
namespace GestaoProff.Steps
{
    ...
    [Binding]
    public class PeriodoLetivoSteps
    {
        [Given("o usuário está na página de adição de períodos letivos")]
        public void GivenTheUserIsOnTheAddAcademicPeriodPage()
        {
            // Implemente a navegação para a página de adição de períodos letivos aqui
        }
