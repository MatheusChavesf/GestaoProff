...
namespace GestaoProff.Steps
{
    ...
    {
        [Given("o usuário está na página de adição de usuários")]
        public void GivenTheUserIsOnTheAddUserPage()
        {
            // Implemente a navegação para a página de adição de usuários aqui
        }
